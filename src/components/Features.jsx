...
const Features = () => {
  return (
    ...
    >
      ...
      <div className="features w-[80%] mx-auto  flex-col flex items-start  justify-start  py-[2rem] flex-wrap gap-8 md:flex-row md:h-[63rem]  md:gap-[1.8rem] lg:py-[1rem] lg:flex-col lg:min-h-[30rem] lg:max-h-[38rem]  lg:w-[88vw] lg:mx-auto xl:h-[40rem]  ">
