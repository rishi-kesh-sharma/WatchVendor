...
const Product = ({
  ...
  return (
    <div className="flex flex-col w-[80%] mx-auto max-h-[2000px]  justify-start items-start md:px-[2rem] md:gap-[3rem]   md:flex-row md:justify-between md:items-center  md:first-of-type:flex-row-reverse lg:justify-center">
      <div className="bg-[url(hexagon.png)] w-[100%] mx-auto  p-[2rem] grid place-items-center  md:w-[25rem] bg-center  bg-contain  bg-no-repeat md:p-7 lg:flex-1 lg:max-w-[30rem] ">
        <img
          className="md:object-contain w-[80%] mx-auto xl:w-[70%] "
          src={image}
          alt={title}
        />
      </div>
